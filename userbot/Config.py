...
if ENV:
    ...
    class Config(object):
        ...
        TELEGRAPH_SHORT_NAME = os.environ.get("TELEGRAPH_SHORT_NAME", "BlackPantherBot")
       ...
       # PLUGIN_CHANNEL = int(os.environ.get("PLUGIN_CHANNEL", None))
        UPSTREAM_REPO = os.environ.get(
            "UPSTREAM_REPO", "https://github.com/BlackPantherBotOP/BlackPantherBot"
        )
        ...
        EXTRA_BLACKPANTHERBOT = os.environ.get("EXTRA_BLACKPANTHERBOT", -1001221881562)
        PM_DATA = os.environ.get("PM_DATA", "ENABLE")
        BLACKPANTHERBOT_LOGGER = int(os.environ.get("BLACKPANTHERBOT_LOGGER", None))
