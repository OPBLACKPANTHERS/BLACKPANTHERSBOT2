...
@bot.on(admin_cmd(pattern=r"blackpanthero$"))
@bot.on(sudo_cmd(pattern="blackpanthero$", allow_sudo=True))
async def bluedevilblackpanthero(blackpanthero):
    if blackpanthero.fwd_from:
        return
    await edit_or_reply(blackpanthero, K)
...
CmdHelp("arts").add_command(
  ...
  'blackpanthero', None, 'Use and see'
).add_command(
