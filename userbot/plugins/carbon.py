...
async def carbon_api(e):
    ...
    blackpanther = await edit_or_reply(e, "`Carbonizing...\n25%`")
    ...
    driver.get(url)
    await blackpanther.edit("`Be Patient...\n50%`")
    download_path = "./"
    ...
    await blackpanther.edit("`Processing..\n75%`")
    # Waiting for downloading
    await asyncio.sleep(2)
    await blackpanther.edit("`Done Dana Done...\n100%`")
    file = "./carbon.png"
    await blackpanther.edit("`Uploading..`")
    await e.client.send_file(
        e.chat_id,
        file,
        caption="Here's your carbon, \n Carbonised by BlackPantherBot",
        force_document=True,
...
async def carbon_api(e):
    if e.fwd_from:
        return
    blackpanther = await edit_or_reply(e, "`Processing....`")
    CARBON = "https://carbon.now.sh/?l={lang}&code={code}"
    textx = await e.get_reply_message()
    pcode = e.text
    if pcode[5:]:
    ...
    pcode = deEmojify(pcode)
    code = quote_plus(pcode)  # Converting to urlencoded
    await blackpanther.edit("`Meking Carbon...`\n`25%`")
    url = CARBON.format(code=code, lang=CARBONLANG)
    chrome_options = Options()
    chrome_options.add_argument("--headless")
...
async def carbon_api(e):
    if e.fwd_from:
        return
    """ A Wrapper for carbon.now.sh """
    blackpanther = await edit_or_reply(e, "🔲🔲🔲🔲🔲")
    ...
    await blackpanther.edit("🔳🔳🔳🔳🔳")
    file = "./carbon.png"
    await blackpanther.edit("☣️Karbon1 Completed, Uploading Karbon☣️")
    await e.client.send_file(
        e.chat_id,
        file,
        force_document=True,
    ...
    os.remove("./carbon.png")
    # Removing carbon.png after uploading
    await blackpanther.delete()  # Deleting msg
...
async def carbon_api(e):
    ...
    await blackpanther.edit("🔘🔘🔘🔘🔘")
    file = "./carbon.png"
    await blackpanther.edit("☣️Karbon2 Completed, Uploading Karbon☣️")
    await e.client.send_file(
        e.chat_id,
        file,
...
async def carbon_api(e):
    ...
    await blackpanther.edit("🔵🔵🔵🔵🔵")
    file = "./carbon.png"
    await blackpanther.edit("☣️Karbon3 Completed, Uploading Karbon⬆️")
    await e.client.send_file(
        e.chat_id,
        file,
...
async def carbon_api(e):
    ...
    await blackpanther.edit("🌝🌝🌝🌝🌝")
    file = "./carbon.png"
    await blackpanther.edit("✅Karbon4 Completed, Uploading Karbon✅")
    await e.client.send_file(
        e.chat_id,
        file,
...
async def carbon_api(e):
    ...
    await blackpanther.edit("⬛⬛⬛⬛⬛")
    file = "./carbon.png"
    await blackpanther.edit("✅RGB Karbon 2.0 Completed, Uploading Karbon✅")
    await e.client.send_file(
        e.chat_id,
        file,
...
async def carbon_api(e):
    ...
    await blackpanther.edit("⬛⬛⬛⬛⬛")
    file = "./carbon.png"
    await blackpanther.edit("✅RGB Karbon Completed, Uploading Karbon✅")
    await e.client.send_file(
        e.chat_id,
        file,
        caption=f"Here's your karbonrgb",
