...
from blackpantherbot.utils import admin_cmd, load_module
from var import Var
...
async def install(event):
    if event.fwd_from:
        return
    chat = Var.BLACKPANTHERBOT_LOGGER
...
CmdHelp("extra_py").add_command(
  'extdl', None, 'Installs all plugins from the channal which id is in BLACKPANTHERBOT_LOGGER variable'
).add_command(
