...
from blackpantherbot.Config import Config
from blackpantherbot.plugins.sql_helper.fban_sql import (
    add_channel,
    get_all_channels,
    in_channels,
    rm_channel,
...
bot = "@MissRose_bot"
blackpanther_logo = "./DANISH_BABA/blackpantherbot_logo.jpg"
# Keep all credits pls
# madewith great effort by @HeisenbergTheDanger
# modified by @kraken_the_badass for fbans


@blackpantherbot.on(admin_cmd(pattern="fban ?(.*)"))
@blackpantherbot.on(sudo_cmd(pattern="fban ?(.*)", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
...
@blackpantherbot.on(admin_cmd(pattern="unfban ?(.*)"))
@blackpantherbot.on(sudo_cmd(pattern="unfban ?(.*)", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
    mssg = await eor(event, "`...`")
...
@blackpantherbot.on(admin_cmd(pattern=r"fadd ?(.*)"))
@blackpantherbot.on(sudo_cmd(pattern=r"fadd ?(.*)", allow_sudo=True))
...
@blackpantherbot.on(admin_cmd(pattern=r"fremove ?(.*)"))
@blackpantherbot.on(sudo_cmd(pattern=r"fremove ?(.*)", allow_sudo=True))
...
@blackpantherbot.on(admin_cmd(pattern="fgroups"))
@blackpantherbot.on(sudo_cmd(pattern="fgroups", allow_sudo=True))
...
@blackpantherbot.on(admin_cmd(pattern="fsearch ?(.*)"))
@blackpantherbot.on(sudo_cmd(pattern="fsearch ?(.*)", allow_sudo=True))
...
@blackpantherbot.on(admin_cmd(pattern="newfed ?(.*)", outgoing=True))
@blackpantherbot.on(sudo_cmd(pattern="newfed ?(.*)", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
    blackpanther_input = event.pattern_match.group(1)
    chat = "@MissRose_Bot"
    ...
    async with borg.conversation(chat) as conv:
        try:
            ...
            await event.client.send_message(chat, f"/newfed {blackpanther_input}")
...
@blackpantherbot.on(admin_cmd(pattern="renamefed ?(.*)"))
@blackpantherbot.on(sudo_cmd(pattern="renamefed ?(.*)", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return 
    blackpanther_input = event.pattern_match.group(1)
    ...
    async with event.client.conversation(chat) as conv:
          try:     
              ...
              await event.client.send_message(chat, f"/renamefed {blackpanther_input}")
              response = await response 
          except YouBlockedUserError: 
...
@blackpantherbot.on(admin_cmd(pattern="fstat ?(.*)"))
@blackpantherbot.on(sudo_cmd(pattern="fstat ?(.*)", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
    blackpanther = await event.edit("`Collecting fstat....`")
    thumb = blackpanther_logo
    if event.reply_to_msg_id:
        previous_message = await event.get_reply_message()
        ...
        async with borg.conversation(bot) as conv:
            try:
                ...
                if "Looks like" in massive.text:
                    ...
                    massive = await conv.get_response()
                    await blackpantherbot.send_file(
                        event.chat_id,
                        massive,
                        thumb=thumb,
                        caption=f"List of feds {user} has been banned in.\n\n**⚡ [Collected using BlackPantherBot](t.me/BlackPantherBot_Support) ⚡**",
                    )
                else:
                    await borg.send_message(event.chat_id, massive.text)
                await event.delete()
            except YouBlockedUserError:
                await blackpanther.edit("`Please Unblock` @MissRose_Bot")


@blackpantherbot.on(admin_cmd(pattern="fedinfo ?(.*)"))
@blackpantherbot.on(sudo_cmd(pattern="fedinfo ?(.*)", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
    blackpanther = await eor(event, "`Fetching fed info.... please wait`")
    lavde = event.pattern_match.group(1)
    async with borg.conversation(bot) as conv:
        try:
            await conv.send_message("/start")
            ...
            massive = await conv.get_response()
            await blackpanther.edit(massive.text + "\n\n**LEGENDARY_AF_BLACKPANTHERBOT**")
        except YouBlockedUserError:
            await blackpanther.edit("`Please Unblock` @MissRose_Bot")
