...
async def hmm(blackpanther):
    if blackpanther.fwd_from:
        return
    reactcat = nekos.textcat()
    await edit_or_reply(blackpanther, reactcat)
...
async def hmm(blackpanther):
    if blackpanther.fwd_from:
        return
    whyblackpanther = nekos.why()
    await edit_or_reply(blackpanther, whyblackpanther)
...
async def hmm(blackpanther):
    if blackpanther.fwd_from:
        return
    factblackpanther = nekos.fact()
    await edit_or_reply(blackpanther, factblackpanther)
