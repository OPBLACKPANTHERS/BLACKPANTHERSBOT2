...
@blackpantherbot.on(admin_cmd(pattern="sin ?(.*)"))
@blackpantherbot.on(sudo_cmd(pattern="sin ?(.*)", allow_sudo=True))
...
@blackpantherbot.on(admin_cmd(pattern="cos ?(.*)"))
@blackpantherbot.on(sudo_cmd(pattern="cos ?(.*)", allow_sudo=True))
...
@blackpantherbot.on(admin_cmd(pattern="tan ?(.*)"))
@blackpantherbot.on(sudo_cmd(pattern="tan ?(.*)", allow_sudo=True))
...
@blackpantherbot.on(admin_cmd(pattern="cosec ?(.*)"))
@blackpantherbot.on(sudo_cmd(pattern="cosec ?(.*)", allow_sudo=True))
...
@blackpantherbot.on(admin_cmd(pattern="sec ?(.*)"))
@blackpantherbot.on(sudo_cmd(pattern="sec ?(.*)", allow_sudo=True))
...
@blackpantherbot.on(admin_cmd(pattern="cot ?(.*)"))
@blackpantherbot.on(sudo_cmd(pattern="cot ?(.*)", allow_sudo=True))
...
@blackpantherbot.on(admin_cmd(pattern="square ?(.*)"))
@blackpantherbot.on(sudo_cmd(pattern="square ?(.*)", allow_sudo=True))
...
@blackpantherbot.on(admin_cmd(pattern="cube ?(.*)"))
@blackpantherbot.on(sudo_cmd(pattern="cube ?(.*)", allow_sudo=True))
