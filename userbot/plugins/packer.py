...
@blackpantherbot.on(admin_cmd(pattern=r"unpack", outgoing=True))
@blackpantherbot.on(sudo_cmd(pattern=r"unpack"))
async def _(event):
...
@blackpantherbot.on(admin_cmd(pattern="repack ?(.*)", outgoing=True))
@blackpantherbot.on(sudo_cmd(pattern="repack ?(.*)", allow_sudo=True))
async def _(event):
