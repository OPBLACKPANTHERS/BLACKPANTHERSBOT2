...
async def _(event):
    ...
    ms = (end - start).microseconds / 1000
    if BLACKPANTHER_IMG:
        blackpanther_caption = f"__**〘 ♕ ᑭσɳց! ♕ 〙__**\n\n   ⚘ {ms}\n   ⚘ __**𝙼𝚢**__ __**𝙼𝚊𝚜𝚝𝚎𝚛**__⟿[{DEFAULTUSER}](tg://user?id={danish_baba})"
        await event.client.send_file(
            event.chat_id, BLACKPANTHER_IMG, caption=blackpanther_caption
        )
        await event.delete()
