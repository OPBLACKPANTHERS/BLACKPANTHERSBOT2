...
async def _(event):
    if not event.text[0].isalpha() and event.text[0] not in ("/", "#", "@", "!"):
        ...
        await edit_or_reply(event, "`Testing BlackPantherBot`")
        ...
        await asyncio.sleep(2)
        await edit_or_reply(event, "**SAVING OUTPUT TO BLACKPANTHERBOT LOCAL DATABASE**")
        await asyncio.sleep(3.5)
        await edit_or_reply(event, 
            "Your[BlackPantherBot](https:/t.me/BlackPantherBot_Support) is working Fine...\n       Join @BlackPantherBot_Chit_Chat For Any Help......"
        )
